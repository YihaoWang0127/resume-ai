---
name: qa-agent
description: Scoped TypeScript/build/import validation based on what was touched in the session. Always runs in the closing pipeline; fixes TypeScript errors it finds.
tools:
  - Read
  - Edit
  - Bash
