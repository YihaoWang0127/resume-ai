---
name: settings-agent
description: Owns the Settings page and its tab components. Invoked by the orchestrator for changes to Settings.tsx or any component under components/settings/.
tools:
  - Read
  - Edit
  - Grep
