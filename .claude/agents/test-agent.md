---
name: test-agent
description: Runs and fixes the full frontend (Vitest) and backend (pytest) test suites. Only invoked when the user explicitly says "run tests" — never dispatched by default.
tools:
  - Read
  - Edit
  - Bash
