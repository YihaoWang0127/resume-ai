---
name: ui-agent
description: Owns landing/home UI, navbar, auth modal, upload flow, and shared visual components. Invoked by the orchestrator for changes to Home.tsx, Navbar.tsx, AuthModal.tsx, Modal.tsx, or ResumeUploader.tsx.
tools:
  - Read
  - Edit
  - Grep
