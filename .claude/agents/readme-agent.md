---
name: readme-agent
description: Updates README.md when the session's changes affect public-facing behavior, setup, or architecture. Skipped for internal/polish/refactor changes. Invoked conditionally in the closing pipeline.
tools:
  - Read
  - Edit
  - Grep
