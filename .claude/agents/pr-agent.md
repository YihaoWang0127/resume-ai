---
name: pr-agent
description: Turns the session's changes into a branch and pull request. Runs last, after qa-agent. Never edits application code — git/GitHub operations only.
tools:
  - Read
  - Bash
  - Grep
