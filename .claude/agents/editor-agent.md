---
name: editor-agent
description: Owns the resume editor, preview, streaming output, and cover letter editor. Invoked by the orchestrator for changes to Editor.tsx, ResumeEditor.tsx, ResumePreview.tsx, StreamingOutput.tsx, or CoverLetterEditor.tsx.
tools:
  - Read
  - Edit
  - Grep
