---
name: shared-agent
description: Owns cross-cutting frontend core — app shell, routing, theme, AuthContext, Supabase client, services layer, and shared UI primitives. Invoked by the orchestrator when App.tsx, index.css, AuthContext, lib/supabase.ts, services/*.ts, ExportMenu, EmptyState, ErrorBoundary, NotFound, or ServerError are touched.
tools:
  - Read
  - Edit
  - Grep
